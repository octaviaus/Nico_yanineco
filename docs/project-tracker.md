...
| Wave 2 / P0 第二批 | **可派** P0-E（接线+打断）与 P0-F（流式 ASR）。G 等 E；H 等 G |
| 下一 REQ | `REQ-003` |
| 下一 ISS | `ISS-08` |
| 下一 BL | `BL-08` |
| 下一 W15 | `W15-08` |
...
无开放 PR。已合入功能分支（#12/#14/#15–#19、`cursor/desktop-pet-landscape-doc-df18`、`cursor/project-tracker-45ab`）**可删远程**。

`character.ts` / `main/index.ts` 已释放。不要再派第二套 P0-A～D 或第二条路 B。
