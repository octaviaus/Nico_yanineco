...
P0-F · PR #24 `cursor/voice-streaming-asr-a62d`（ST-VOICE-03，只 `packages/voice`）。P0-E 分支 `cursor/pet-phase-wiring-barge-in-1098` 合入后可删远程。
...
P0-F `in_progress`（PR #24）。P0-E 已合入。

**现在可派：** P0-G（ST-VIZ-03，占 `character.ts` / `main`）。P0-F 不要重开。
...
| P0-F | ST-VOICE-03 | **现在** ∥ E | `packages/voice/**` | `in_progress` · cloud · `cursor/voice-streaming-asr-a62d` · PR #24 |
